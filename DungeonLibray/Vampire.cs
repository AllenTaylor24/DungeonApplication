...
namespace DungeonLibray
{
    public sealed class Vampire : Monster
    {
        ...
        public Vampire(string name, int maxLife, int hitChance, int block, int life, int maxDamage, int minDamage, string description)
            : base(name, maxLife, hitChance, block, life, maxDamage, minDamage, description)
        {
